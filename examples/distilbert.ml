(* Use a pre-trained DistilBert model for the masked-LM task.

   The weights and vocabulary files can be downloaded from the following links.
   These are published under the Apache 2.0 license by HuggingFace.
   ...
   https://github.com/guillaume-be/rust-bert/blob/master/examples/distilbert_masked_lm.rs
*)
open! Base
open! Torch
